(()=>{
  ...
  function ensureStyle(){
    ...
    s.textContent=`#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]){display:block!important;margin-top:18px!important;padding:24px!important;border:1px solid #d7eadf!important;border-radius:24px!important;background:linear-gradient(180deg,#f7fcf9 0%,#eff9f3 100%)!important;box-shadow:0 10px 34px rgba(15,82,52,.07)}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-config-title{display:flex!important;align-items:flex-start!important;gap:14px!important;margin-bottom:20px!important}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-config-icon{width:52px;height:52px;flex:0 0 52px;border-radius:50%;display:grid;place-items:center;background:#dff4e8;color:#087443}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-config-icon svg{width:28px;height:28px;display:block}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-config-title h3{margin:1px 0 0;font-size:28px;line-height:1.08;letter-spacing:-.55px;color:#17251e}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-config-title p{margin:7px 0 0;color:#68786f;font-size:16px;line-height:1.35}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-choices{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px;margin-bottom:18px}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-choices button{min-height:92px;display:flex;align-items:center;gap:13px;position:relative;text-align:left;border:1px solid #dce8e1;border-radius:17px;background:#fff;padding:14px 16px;color:#17251e;box-shadow:0 5px 16px rgba(23,37,30,.045);transition:transform .16s ease,border-color .16s ease,box-shadow .16s ease,background .16s ease}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-choices button:hover{transform:translateY(-1px);border-color:#a8cbb7;box-shadow:0 8px 20px rgba(23,37,30,.07)}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-choices button:focus-visible{outline:3px solid rgba(8,116,67,.23);outline-offset:2px}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-choices button.on{background:linear-gradient(135deg,#078a4d 0%,#087443 100%);border-color:#087443;color:#fff;box-shadow:0 10px 23px rgba(8,116,67,.18)}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-choice-icon{width:34px;height:34px;flex:0 0 34px;display:grid;place-items:center}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-choice-icon svg{width:31px;height:31px;display:block}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-choices span strong{display:block;font-size:17px;line-height:1.18}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-choices span small{display:block;margin-top:5px;color:#68786f;font-size:13px;font-weight:700}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-choices button.on span small{color:#dcf3e6}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-choice-check{margin-left:auto;display:grid;place-items:center;width:31px;height:31px;flex:0 0 31px;border-radius:50%;background:#fff;color:#087443;font-size:19px;font-weight:900}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-product{margin-top:0;padding:19px;border:1px solid #dce9e1;border-radius:20px;background:#fff;box-shadow:0 7px 24px rgba(23,37,30,.045)}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-product-head{display:flex;align-items:center;justify-content:space-between;gap:14px;margin-bottom:14px}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-product-head>strong{font-size:19px;letter-spacing:-.2px}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-product-head>span{display:inline-flex;align-items:center;gap:6px;padding:7px 11px;border-radius:999px;background:#e4f7ec;color:#087443;font-size:12px;font-weight:900;white-space:nowrap}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-product-main{display:grid;grid-template-columns:minmax(0,1.08fr) minmax(230px,.92fr);gap:20px;align-items:center}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-product-main>img{width:100%;height:235px;object-fit:contain;border-radius:15px;background:linear-gradient(180deg,#eef5f1,#e7f0eb)}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-product-main h3{font-size:23px;line-height:1.2;margin:0 0 9px;letter-spacing:-.3px;color:#17251e}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-product-main p{margin:0;color:#68786f;font-size:16px;line-height:1.52}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-thumbs{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px;margin-top:13px}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-thumbs figure{margin:0;padding:0 0 7px;border:1px solid #edf2ef;border-radius:12px;background:#fff;overflow:hidden}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-thumbs img{display:block;width:100%;height:92px;object-fit:cover;background:#edf3ef}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-thumbs figcaption{text-align:center;font-size:12px;margin-top:7px;padding:0 4px;color:#394d42}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-tip{display:flex;align-items:flex-start;gap:11px;margin-top:15px;padding:15px 17px;border-radius:15px;background:linear-gradient(90deg,#e7f8ee 0%,#effaf4 100%);color:#486157;font-size:14px;line-height:1.47}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-tip-icon{width:28px;height:28px;flex:0 0 28px;color:#079052}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-tip-icon svg{width:28px;height:28px;display:block}@media(max-width:760px){#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]){padding:18px!important;border-radius:20px!important}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-config-title h3{font-size:22px}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-config-title p{font-size:14px}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-config-icon{width:45px;height:45px;flex-basis:45px}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-choices{grid-template-columns:1fr;gap:9px}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-choices button{min-height:67px;padding:11px 13px}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-product{padding:14px}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-product-main{grid-template-columns:1fr;gap:13px}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-product-main>img{height:190px}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-product-main h3{font-size:20px}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-product-main p{font-size:14px}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-thumbs{grid-template-columns:1fr 1fr}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-thumbs img{height:96px}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-product-head{align-items:flex-start}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-product-head>strong{font-size:17px}#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"]) .mobile-tip{font-size:13px;padding:13px}}`;
  ...
  function hedgeProduct(s){
    ...
    const choices=Object.entries(hedgeVariants).map(([value,item])=>'<button type="button" data-eg="variant" data-ev="'+value+'" aria-pressed="'+(s.variant===value)+'" class="'+(s.variant===value?'on':'')+'"><span><strong>'+item.title+'</strong><small>'+item.sub+'</small></span>'+(s.variant===value?'<b class="mobile-choice-check" aria-hidden="true">✓</b>':'')+'</button>').join('');
