(function(root,factory){
  ...
  const mobile={panelLength:3.5,panelUnit:1286,footUnit:176,connectorUnit:78};
  ...
  function computeExtraFencePrice(input={}){
    ...
    if(type==='mobile'){
      ...
      return{unsupported:false,kind:'mobile-mesh',materialTotal,panels,feet,connectors,panelCost,feetCost,connectorCost,counts,runs,length,height};
    }
