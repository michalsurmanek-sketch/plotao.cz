(()=>{
  ...
  function init(){render();document.addEventListener('input',()=>schedule(60));document.addEventListener('change',e=>{if(criticalChange(e)){resetPending();return}schedule(60)});document.addEventListener('click',e=>{if(window.PLOTAO_IS_PRICE_CLICK(e))schedule(100)});document.addEventListener('plotao:panel-price',()=>schedule(40));document.addEventListener('plotao:mesh-price',()=>schedule(40));document.addEventListener('plotao:placement',()=>schedule(40));document.addEventListener('plotao:slab-price',()=>schedule(40));document.addEventListener('plotao:options-reset',resetPending);document.addEventListener('plotao:input-validity',()=>schedule(0))}
