...
ok(performance.includes('const MAX_SCRIPT_COUNT=60;')&&performance.includes('const MAX_TOTAL_BYTES=300*1024;')&&performance.includes('const MAX_SINGLE_BYTES=16*1024;'),'homepage performance budget must stay at the reviewed 60-script / 300 KiB total / 16 KiB single-module limits unless explicitly re-reviewed');
