...
console.log(`Build pipeline checks OK: ${activeScripts.length} unique active assets exist; Pages uploads strict dist only; deploy pipeline and standalone live smoke verify marker + HTML`);
