export const activeScripts=[
  '/assets/ui-bootstrap-v1.js','/assets/segment-connections-v1.js','/assets/calculator-v3.js','/assets/geometry-core-v1.js','/assets/geometry-v3.js','/assets/geometry-validity-v1.js','/assets/gabion-options.js','/assets/aluminium-config.js','/assets/privacy-config.js','/assets/metal-config.js','/assets/concrete-config.js','/assets/extra-fence-config.js','/assets/options-router-v1.js','/assets/panel-slab-safety-v1.js','/assets/structural-pricing-v5.js','/assets/panel-pricing-v5.js','/assets/mesh-pricing-v2.js','/assets/aluminium-pricing.js','/assets/privacy-pricing.js','/assets/metal-pricing.js','/assets/extra-fence-pricing.js','/assets/slab-pricing-v2.js','/assets/concrete-material-v1.js','/assets/gate-pricing-v1.js','/assets/gate-drive-pricing-v1.js','/assets/scope-integrity.js','/assets/price-bridge.js','/assets/mobile-price-bridge.js','/assets/accuracy-guard.js','/assets/lead-safety-v1.js','/assets/step-scroll-v1.js','/assets/ui-truth-v1.js'
];

export const requiredArtifact=[
  'name="plotao-deploy"','/assets/ui-bootstrap-v1.js','/assets/geometry-core-v1.js','data-v="material" class="on"','Ceník aktualizován 12. 9. 2026','<input id="gate" type="checkbox">','<input id="door" type="checkbox">','<title>Kalkulátor ceny plotu a materiálu | PLOTAO.cz</title>','<h1>Spočítejte materiál na celý plot. Hned.</h1>','Spočítejte ověřený materiálový rozpočet plotu podle typu','Ověřený materiál spočítáme hned.','terén, podloží a přístup slouží jako podklady pro individuální realizační nabídku.'
];
