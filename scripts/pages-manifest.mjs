export const activeScripts=[
  '/assets/ui-bootstrap-v1.js','/assets/segment-limit-ui-v1.js','/assets/segment-connections-v1.js','/assets/calculator-v3.js','/assets/geometry-core-v1.js','/assets/geometry-v3.js','/assets/geometry-validity-v1.js','/assets/gabion-options.js','/assets/aluminium-config.js','/assets/privacy-config.js','/assets/metal-config.js','/assets/concrete-config.js','/assets/extra-fence-config.js','/assets/options-router-v1.js','/assets/panel-slab-safety-v1.js','/assets/structural-pricing-core-v1.js','/assets/structural-pricing-v5.js','/assets/panel-pricing-core-v1.js','/assets/panel-pricing-v5.js','/assets/mesh-pricing-core-v1.js','/assets/mesh-pricing-v2.js','/assets/aluminium-pricing-core-v1.js','/assets/aluminium-pricing.js','/assets/privacy-pricing-core-v1.js','/assets/privacy-pricing.js','/assets/metal-pricing.js','/assets/extra-fence-pricing-core-v1.js','/assets/extra-fence-pricing.js','/assets/slab-pricing-core-v1.js','/assets/slab-pricing-v2.js','/assets/concrete-material-core-v1.js','/assets/concrete-material-v1.js','/assets/gate-pricing-core-v1.js','/assets/gate-pricing-v1.js','/assets/gate-drive-pricing-core-v1.js','/assets/gate-drive-pricing-v1.js','/assets/input-validity-guard-v1.js','/assets/scope-integrity.js','/assets/price-total-core-v1.js','/assets/price-bridge.js','/assets/gate-total-pending-v1.js','/assets/mobile-price-bridge.js','/assets/accuracy-guard.js','/assets/lead-option-details-v1.js','/assets/lead-core-v1.js','/assets/lead-transport-core-v1.js','/assets/lead-transport-config-v1.js','/assets/lead-transport-v1.js','/assets/lead-safety-v1.js','/assets/lead-mode-ui-v1.js','/assets/modal-accessibility-v1.js','/assets/choice-accessibility-v1.js','/assets/step-scroll-v1.js','/assets/gate-ui-v1.js','/assets/ui-truth-v1.js','/assets/mobile-summary-state-v1.js','/assets/mobile-safe-area-v1.js','/assets/footer-logo-v1.js'
];
