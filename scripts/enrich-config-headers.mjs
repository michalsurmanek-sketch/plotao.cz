...
#aluminiumConfigBox>.mobile-config-title,#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"])>.mobile-config-title,#extraFenceConfig[data-type="other"]>.atyp-head,.config-intro{margin:0 0 24px!important;min-height:84px}
...
#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"])>.mobile-config-title{gap:20px!important;align-items:flex-start!important}
#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"])>.mobile-config-title .mobile-config-icon{width:68px!important;height:68px!important;flex:0 0 68px!important;background:#dff4e8!important;color:#087443!important}
#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"])>.mobile-config-title .mobile-config-icon svg{width:34px!important;height:34px!important}
#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"])>.mobile-config-title h3{margin:0!important;font-size:30px!important;line-height:1.06!important;letter-spacing:-.6px!important;color:#17251e!important}
#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"])>.mobile-config-title p{margin:10px 0 0!important;color:#68786f!important;font-size:18px!important;line-height:1.35!important}
...
#aluminiumConfigBox>.mobile-config-title h3,#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"])>.mobile-config-title h3,#metalConfig>h3,#concreteConfig>h3,.config-intro h3,#extraFenceConfig[data-type="other"]>.atyp-head h3{font-size:28px!important;line-height:1.04!important}
#aluminiumConfigBox>.mobile-config-title p,#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"])>.mobile-config-title p,#metalConfig>h3:after,#concreteConfig>h3:after,.config-intro p,#extraFenceConfig[data-type="other"]>.atyp-head p{font-size:16px!important;line-height:1.35!important}
#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"])>.mobile-config-title{gap:16px!important;margin-bottom:20px!important}
#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"])>.mobile-config-title .mobile-config-icon{width:64px!important;height:64px!important;flex-basis:64px!important}
#extraFenceConfig:is([data-type="mobile"],[data-type="masonry"],[data-type="hedge"])>.mobile-config-title .mobile-config-icon svg{width:31px!important;height:31px!important}
