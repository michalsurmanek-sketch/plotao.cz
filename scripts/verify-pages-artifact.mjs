...
console.log(`Pages artifact integrity OK: ${marker}; ${activeScripts.length} content-versioned modules, structured data, social metadata and logo dimensions verified`);
