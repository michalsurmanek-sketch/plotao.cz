...
ok(price.includes("main.textContent='Přepočítávám…';delete main.dataset.benchmarkTotal")&&price.includes("if(mobile)mobile.textContent='Přepočítávám…'"),'losing a generic benchmark must neutralize desktop and sticky totals immediately');
...
console.log('Total ownership checks OK: generic, DOPS, accuracy and gate-pending states cannot leak an old main price across transitions');
