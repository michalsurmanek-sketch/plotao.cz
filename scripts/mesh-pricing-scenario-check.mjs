...
ok(p.meshCost===2610&&p.lineCost===2360&&p.termCost===885&&p.braceCost===892,'mesh slab structural cost breakdown must stay stable');
...
ok(p.materialTotal===13472,'30m welded green verified core must stay 13,472 CZK');
