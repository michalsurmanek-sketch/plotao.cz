...
ok(src.includes("if(h&&(hv<40||hv>400))return h")&&src.includes("const bad=$$('#segmentList input[type=number]').find(x=>+(x.value||0)<=0)")&&src.includes("window.PLOTAO_PLACEMENT?.valid===false"),'invalid CTA must route to the actual broken height, segment or opening input and enforce the 40–400cm range');
