...
console.log('Lead scope payload checks OK: authoritative opening placement wins over DOM lag, geometry/section limits win over scope fallback, and delivery/turnkey cannot inherit stale material totals');
