...
ok(ui.includes("state[key]=value;setChoice(attr,value)")&&ui.includes("focusChoice(attr,value)") ,'panel/mesh option choices must preserve selection and restore focus without recreating the whole options panel');
