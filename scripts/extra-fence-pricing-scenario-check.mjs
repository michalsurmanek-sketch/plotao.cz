...
const require=createRequire(import.meta.url),{computeExtraFencePrice}=require('../assets/extra-fence-pricing-core-v1.js');
...
console.log('Extra fence pricing scenario checks OK: mobile per-run hardware and masonry reference protected');
